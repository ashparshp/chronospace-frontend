      ...
      tabs.push({
        ...
        content: (
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 rounded-lg shadow-sm p-2 mb-6">
              <div className="relative flex items-center">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-2.5 rounded-lg border-0 ring-0 focus:ring-0 focus:outline-none bg-transparent text-stone-700 dark:text-stone-300 placeholder-gray-400 font-body"
                />
                {searchQuery && (
                  <button
                    className="absolute right-3 text-stone-400 hover:text-stone-600 dark:hover:text-gray-200"
            ...
            {loadingPublished && publishedBlogs.length === 0 ? (
              <div className="space-y-4">
                {Array.from({ length: 3 }).map((_, index) => (
                  <div
                    key={index}
                    className="bg-white dark:bg-stone-800 rounded-xl overflow-hidden shadow-sm border border-stone-100 dark:border-stone-700"
                  >
                    <div className="p-5">
              ...
              <div className="space-y-4">
                {publishedBlogs.map((blog, index) => (
                  ...
                  >
                    <div className="bg-white dark:bg-stone-800 rounded-xl overflow-hidden shadow-sm border border-stone-100 dark:border-stone-700 hover:shadow-md transition-all duration-200 hover:border-primary-200 dark:hover:border-primary-800">
                      <div className="p-5">
                          ...
                          <div className="flex gap-4">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-2">
                                <h3 className="font-heading text-lg font-bold text-stone-900 dark:text-white hover:text-primary-600 dark:hover:text-primary-400 transition-colors duration-200 truncate">
                                  {blog.title}
                                </h3>
                                {index < 2 && (
                                  <Badge
                              ...
                              <div className="flex items-center text-xs text-stone-500 dark:text-stone-400 space-x-3 mt-1 font-body">
                              ...
                              {blog.des && (
                                <p className="font-body text-stone-600 dark:text-stone-300 text-sm mt-2 line-clamp-2">
                                  {blog.des}
                                </p>
                              )}
              ...
              <div className="text-center py-16 bg-white dark:bg-stone-800 rounded-xl shadow-sm border border-stone-100 dark:border-stone-700">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-violet-100 dark:bg-primary-900/40 text-primary-600 dark:text-primary-400 mb-4">
                  <FileText className="h-8 w-8" />
                </div>
                <h3 className="font-heading text-xl font-bold text-stone-900 dark:text-white mb-2">
                  No published blogs yet
                </h3>
                <p className="font-body text-stone-600 dark:text-stone-400 max-w-md mx-auto mb-6">
        ...
        content: (
          <div className="space-y-6">
            ...
            {loadingDrafts && draftBlogs.length === 0 ? (
                    ...
                    <div className="bg-white dark:bg-stone-800 rounded-xl overflow-hidden shadow-sm border border-stone-100 dark:border-stone-700 hover:shadow-md transition-all duration-200 hover:border-primary-200 dark:hover:border-primary-800">
                      <div className="p-5">
                        <div className="flex flex-col sm:flex-row justify-between gap-4">
                          <div className="flex gap-4">
                            <div className="hidden sm:block">
                              <div className="w-16 h-16 rounded-lg bg-stone-100 dark:bg-stone-700 flex items-center justify-center">
                                <PenLine className="h-8 w-8 text-stone-500 dark:text-stone-400" />
                              </div>
                            </div>
              ...
              <div className="text-center py-16 bg-white dark:bg-stone-800 rounded-xl shadow-sm border border-stone-100 dark:border-stone-700">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-stone-100 dark:bg-stone-700 text-stone-500 dark:text-stone-400 mb-4">
          ...
          {notificationsLoading && notifications.length === 0 ? (
            ...
            <div className="space-y-4">
              {notifications.map((notification, index) => (
                ...
                >
                  <div
                    className={`bg-white dark:bg-stone-800 rounded-xl overflow-hidden shadow-sm transition-all duration-200 hover:shadow-md ${
                      !notification.seen
                        ? "border-l-4 border-primary-500 dark:border-primary-500 border-y border-r border-stone-100 dark:border-stone-700"
                      ...
                      <div className="flex items-start">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-1">
                            <div>
                              <span
                                className="font-body font-medium text-stone-900 dark:text-white cursor-pointer hover:text-primary-600 dark:hover:text-primary-400 transition-colors"
                                onClick={() =>
                                  navigate(
                                    `/profile/${notification.user?.personal_info.username}`
                                  )
                              ...
                              <span className="font-body text-stone-700 dark:text-stone-300 ml-1.5">
                                {renderNotificationContent(notification)}
                              </span>
                            </div>

                            <p className="text-xs text-stone-500 dark:text-stone-400 font-body mt-1 sm:mt-0">
                              {format(
                          ...
                          {notification.comment && (
                            <div className="mt-2 p-3 bg-stone-50 dark:bg-stone-900/50 rounded-lg">
                              <p className="text-sm text-stone-600 dark:text-stone-400 font-body italic">
                          ...
                          <div className="flex justify-between items-center mt-3">
                            ...
                            <Button
                              ...
                              className="text-stone-400 hover:text-stone-500 dark:hover:text-gray-300"
            ...
            <div className="text-center py-16 bg-white dark:bg-stone-800 rounded-xl shadow-sm border border-stone-100 dark:border-stone-700">
              ...
              <p className="font-body text-stone-600 dark:text-stone-400 max-w-md mx-auto">
        ...
        content: (
          <div className="space-y-6">
            ...
            {loadingBloggerStatus ? (
              <div className="bg-white dark:bg-stone-800 rounded-xl overflow-hidden shadow-sm border border-stone-100 dark:border-stone-700 p-6">
                <div className="animate-pulse">
                  <div className="flex justify-center">
                    <div className="w-20 h-20 bg-stone-200 dark:bg-stone-700 rounded-full mb-6"></div>
                  </div>
                  <div className="h-6 bg-stone-200 dark:bg-stone-700 rounded w-3/4 mx-auto mb-4"></div>
                  <div className="h-4 bg-stone-200 dark:bg-stone-700 rounded w-full mb-2"></div>
                  <div className="h-4 bg-stone-200 dark:bg-stone-700 rounded w-full mb-2"></div>
                  <div className="h-4 bg-stone-200 dark:bg-stone-700 rounded w-3/4 mb-6"></div>
                  <div className="h-10 bg-stone-200 dark:bg-stone-700 rounded w-40 mx-auto"></div>
                </div>
              </div>
            ) : currentUser?.role === "blogger" ||
              currentUser?.role === "admin" ? (
              <div className="bg-white dark:bg-stone-800 rounded-xl overflow-hidden shadow-md border border-stone-100 dark:border-stone-700">
                <div className="p-8 text-center">
                  ...
                  <h3 className="font-heading text-2xl font-bold text-stone-900 dark:text-white mb-3">
                    You Are a Blogger
                  </h3>
                  <p className="font-body text-stone-600 dark:text-stone-400 max-w-lg mx-auto mb-8">
                ...
                <div className="p-8 text-center">
                  {bloggerStatus.status === "pending" ? (
                    <>
                      ...
                      <p className="font-body text-stone-600 dark:text-stone-400 max-w-lg mx-auto mb-4">
                      ...
                      <div className="flex items-center justify-center mb-8">
                        <p className="px-4 py-2 bg-stone-100 dark:bg-stone-900/50 rounded-full text-sm text-stone-700 dark:text-stone-300 font-body">
                      ...
                      <div className="max-w-md mx-auto bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
                        <p className="text-sm text-blue-700 dark:text-blue-300 font-body">
                    ...
                    <>
                      ...
                      <p className="font-body text-stone-600 dark:text-stone-400 max-w-lg mx-auto mb-6">
                      ...
                      {bloggerStatus.review_notes && (
                        <div className="bg-stone-50 dark:bg-stone-900/50 p-5 rounded-lg mb-8 max-w-lg mx-auto">
                          <p className="text-sm font-medium text-stone-700 dark:text-stone-300 mb-2 font-body">
                            Reviewer Feedback:
                          </p>
                          <p className="text-sm text-stone-600 dark:text-stone-400 font-body italic">
                            "{bloggerStatus.review_notes}"
    ...
    <div className="mx-auto">
      ...
      >
            ...
            <div className="relative z-10">
              <div className="flex flex-col md:flex-row justify-between items-center">
                <div className="mb-6 md:mb-0 max-w-3xl">
                  <motion.h1
                    className="font-heading text-4xl md:text-5xl font-bold mb-4 tracking-tight leading-tight text-center md:text-left"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  <motion.p
                    className="font-body text-lg mb-6 leading-relaxed italic text-stone-700 dark:text-stone-300 text-center md:text-left"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
        ...
        <div className="bg-white dark:bg-stone-800 rounded-xl overflow-hidden shadow-md border border-stone-100 dark:border-stone-700">
          ...
          <div className="flex flex-wrap overflow-x-auto scrollbar-hide border-b border-stone-200 dark:border-stone-700 px-4">
    ...
    <div className="bg-white dark:bg-stone-800 rounded-xl overflow-hidden shadow-md border border-stone-100 dark:border-stone-700">
      <div className="relative overflow-hidden">
        ...
        <div className="p-6 pb-5">
          {/* Progress Bar */}
          <div className="w-full h-1 bg-stone-200 dark:bg-stone-700 rounded-full overflow-hidden mb-4">
            <div
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              <div className="bg-violet-100 dark:bg-primary-900/30 p-2 rounded-full mr-3">
        ...
        <div className="px-6 pb-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label
                htmlFor="reason"
                className="block text-sm font-medium text-stone-700 dark:text-stone-300 mb-2 font-body"
              >
              ...
              <textarea
                ...
                } bg-white dark:bg-stone-900 text-stone-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-primary-500 font-body text-sm`}
                required
              />
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 rounded-lg border border-stone-300 dark:border-stone-700 bg-white dark:bg-stone-900 text-stone-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-primary-500 font-body text-sm"
              />
              <p className="text-xs text-stone-500 dark:text-stone-400 mt-1.5 font-body">
