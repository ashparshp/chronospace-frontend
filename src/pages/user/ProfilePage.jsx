    ...
    return (
      <div className=" mx-auto space-y-8 animate-pulse">
        <div className="bg-white dark:bg-black rounded-lg shadow-md overflow-hidden">
          <div className="h-48 bg-gray-200 dark:bg-black"></div>
          <div className="p-6">
            <div className="flex flex-col items-center -mt-24">
              <div className="h-36 w-36 rounded-full bg-gray-200 dark:bg-black border-4 border-white dark:border-gray-800"></div>
              <div className="mt-4 space-y-2 text-center">
                <div className="h-8 bg-gray-200 dark:bg-black rounded w-48 mx-auto"></div>
                <div className="h-4 bg-gray-200 dark:bg-black rounded w-32 mx-auto"></div>
                <div className="h-4 bg-gray-200 dark:bg-black rounded w-64 mx-auto"></div>
              </div>
            </div>
          </div>
        </div>
