          ...
          <div className="relative bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 py-8 px-6">
            ...
            <div className="relative z-10">
              <div className="max-w-3xl mx-auto text-center mb-6">
                <motion.h1
                  className="font-heading text-3xl md:text-4xl font-bold mb-4 tracking-tight leading-tight"
                ...
                <motion.p
                  className="font-body text-lg leading-relaxed text-stone-700 dark:text-stone-300 max-w-xl mx-auto"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                <form onSubmit={handleSearchSubmit} className="space-y-4">
                  <div className="flex flex-col md:flex-row gap-4">
                    <div className="flex-1">
                      <Input
                        ...
                        icon={<SearchIcon className="h-5 w-5 text-stone-400" />}
                        className="w-full bg-white/90 dark:bg-stone-800/90 border-stone-200 dark:border-stone-700"
                      />
                    </div>
                  ...
                  {showFilters && (
                    <motion.div
                      ...
                      className="bg-white/80 dark:bg-stone-800/80 backdrop-blur-sm rounded-xl border border-stone-200 dark:border-stone-700 p-4 shadow-sm"
                    >
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            icon={<TagIcon className="h-5 w-5 text-stone-400" />}
                ...
                {(query.tag || query.category || query.author) && (
                  <div className="flex flex-wrap gap-2 mt-4">
                    {query.tag && (
                      <Badge
                        variant="secondary"
                        className="flex items-center bg-white/80 dark:bg-stone-800/80 text-violet-700 dark:text-violet-300 border border-violet-200 dark:border-violet-800 py-1 px-3"
                      >
                        <span className="mr-1 font-body">Tag:</span>{" "}
                        <span className="font-medium">{query.tag}</span>
                        <button
                          className="ml-2 text-stone-500 hover:text-stone-700 dark:text-stone-400 dark:hover:text-gray-300"
                    ...
                    {query.category && (
                      <Badge
                        variant="secondary"
                        className="flex items-center bg-white/80 dark:bg-stone-800/80 text-indigo-700 dark:text-indigo-300 border border-indigo-200 dark:border-indigo-800 py-1 px-3"
                      >
                        <span className="mr-1 font-body">Category:</span>{" "}
                    ...
                    {query.author && (
                      <Badge
                        variant="secondary"
                        className="flex items-center bg-white/80 dark:bg-stone-800/80 text-pink-700 dark:text-pink-300 border border-pink-200 dark:border-pink-800 py-1 px-3"
                      >
                        <span className="mr-1 font-body">Author:</span>{" "}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-8 max-w-3xl mx-auto">
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <div className="bg-primary-500/20 rounded-lg p-2.5">
                        <BookOpen className="h-6 w-6 text-primary-600 dark:text-primary-400" />
                      </div>
                    </div>
                    <div className="mt-3 pt-3 border-t border-stone-200 dark:border-stone-700/30">
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-primary-600 dark:text-primary-400 font-medium font-body">
                          View Results
                        </span>
                  ...
                  >
                    ...
                    <div className="mt-3 pt-3 border-t border-stone-200 dark:border-stone-700/30">
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-indigo-600 dark:text-indigo-400 font-medium font-body">
                          View Results
                        </span>
                  ...
                  >
                    ...
                    <div className="mt-3 pt-3 border-t border-stone-200 dark:border-stone-700/30">
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-pink-600 dark:text-pink-400 font-medium font-body">
                          View All Tags
                        </span>
        ...
        <Card className="border border-stone-100 dark:border-stone-800 shadow-md overflow-hidden">
          <div className="border-b border-stone-200 dark:border-stone-700">
            <nav className="-mb-px flex" aria-label="Tabs">
              <button
                ...
                className={`whitespace-nowrap py-4 px-6 font-medium text-sm transition-colors duration-200 ${
                  activeTab === "blogs"
                    ...
                    : "border-transparent text-stone-600 hover:text-gray-800 hover:border-stone-300 dark:text-stone-400 dark:hover:text-gray-300 dark:hover:border-gray-700 font-body"
                }`}
              ...
              <button
                ...
                className={`whitespace-nowrap py-4 px-6 font-medium text-sm transition-colors duration-200 ${
                  activeTab === "users"
                    ? "border-b-2 border-indigo-500 text-indigo-600 dark:text-indigo-400 font-body"
                    : "border-transparent text-stone-600 hover:text-gray-800 hover:border-stone-300 dark:text-stone-400 dark:hover:text-gray-300 dark:hover:border-gray-700 font-body"
                }`}
              ...
              <button
                ...
                className={`whitespace-nowrap py-4 px-6 font-medium text-sm transition-colors duration-200 ${
                  activeTab === "tags"
                    ? "border-b-2 border-pink-500 text-pink-600 dark:text-pink-400 font-body"
                    : "border-transparent text-stone-600 hover:text-gray-800 hover:border-stone-300 dark:text-stone-400 dark:hover:text-gray-300 dark:hover:border-gray-700 font-body"
                }`}
          ...
          <div className="p-6">
                    ...
                    <div className="flex items-center space-x-2">
                      <button
                        className={`p-2 rounded-md ${
                          viewMode === "grid"
                            ? "bg-violet-100 dark:bg-primary-900/20 text-primary-600 dark:text-primary-400"
                            : "text-stone-500 dark:text-stone-400 hover:bg-stone-100 dark:hover:bg-gray-800/50"
            ...
            {activeTab === "users" && (
              <div>
                <div className="mb-6">
                  <h2 className="font-heading text-2xl font-bold mb-1 bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-violet-600 dark:from-indigo-400 dark:to-violet-400">
                    {loading
                      ? "Searching users..."
                      : users.length === 0
                      ? "No users found"
                ...
                {loading && users.length === 0 ? (
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {Array.from({ length: 6 }).map((_, i) => (
                      <div
                        key={i}
                        className="animate-pulse bg-white dark:bg-stone-800 rounded-xl overflow-hidden shadow-sm border border-stone-100 dark:border-stone-700 p-4"
                      >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {users.map((user, index) => (
                      ...
                      >
                        <Card
                          className="p-4 cursor-pointer border border-stone-100 dark:border-stone-800 hover:border-indigo-200 dark:hover:border-indigo-800 hover:shadow-md transition-all duration-200"
                          onClick={() =>
                        ...
                        >
                          <div className="flex items-center space-x-4">
                            ...
                            />
                            <div>
                              <h3 className="font-heading font-bold text-stone-900 dark:text-white">
                          ...
                          {user.personal_info.bio && (
                            <p className="text-sm text-stone-600 dark:text-stone-400 mt-3 font-body line-clamp-2">
                              {user.personal_info.bio}
                            </p>
                          )}
                          <div className="mt-3 pt-3 border-t border-stone-100 dark:border-stone-800 text-xs text-stone-500 dark:text-stone-400 flex items-center justify-between font-body">
                            ...
                            <div className="flex items-center">
                              <Users className="h-3.5 w-3.5 mr-1.5 text-violet-500 dark:text-primary-400" />
                              <span>
                  ...
                  !loading && (
                    <EmptyState
                      ...
                      icon={<User className="h-16 w-16 text-stone-400" />}
                      className="bg-white dark:bg-stone-800 rounded-xl p-10 border border-stone-100 dark:border-stone-700"
                    />
                  )
                )}
            ...
            {activeTab === "tags" && (
              <div>
                <div className="mb-6">
                  <h2 className="font-heading text-2xl font-bold mb-1 bg-clip-text text-transparent bg-gradient-to-r from-pink-600 to-rose-600 dark:from-pink-400 dark:to-rose-400">
                    Popular Tags
                  </h2>
                  <motion.div
                ...
                <div className="flex flex-wrap gap-3">
                  {tags.map((tag, index) => (
                    ...
                    >
                      <Badge
                        variant="secondary"
                        className="py-2 px-3 cursor-pointer text-base font-medium tracking-wide font-mono lowercase bg-white dark:bg-stone-800 border border-stone-200 dark:border-stone-700 hover:border-pink-300 dark:hover:border-pink-700 hover:bg-pink-50 dark:hover:bg-pink-900/20 transition-colors duration-200 shadow-sm"
                ...
                <div className="mt-8 bg-pink-50 dark:bg-pink-900/10 rounded-xl p-4 border border-pink-100 dark:border-pink-900/30">
                  <div className="flex items-start">
                    <div className="bg-white dark:bg-stone-800 rounded-full p-2 mr-4 shadow-sm">
                      <TagIcon className="h-6 w-6 text-pink-600 dark:text-pink-400" />
                    </div>
                    <div>
                      <h3 className="font-heading font-bold text-lg text-stone-900 dark:text-white mb-1">
